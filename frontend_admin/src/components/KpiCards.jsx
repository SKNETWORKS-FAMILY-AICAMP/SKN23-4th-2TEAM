function KpiCards({ summary, onErrorClick, onProcessingClick, onDoneClick }) {
  ...
  const cards = [
    { title: "총 에러", value: summary.total_errors ?? 0, color: "text-red-500", click: onErrorClick },
    { title: "정상", value: summary.resolved_count ?? 0, color: "text-green-500", click: onDoneClick },
    { title: "처리중", value: summary.ongoing_count ?? 0, color: "text-yellow-500", click: onProcessingClick },
